  ...
  (delay
   (du/profile "resolve metabase.driver.generic-sql-test/generic-sql-engines"
     (set (for [engine datasets/all-valid-engines
                ...
                :when  (not (contains? #{:bigquery :presto :sparksql :athena} engine)) ; bigquery, presto and sparksql don't use the generic sql implementations of things like `field-avg-length`
